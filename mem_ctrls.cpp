...
uint64_t SimpleMemory::access(MemReq& req) {
    //if (req.flags & MemReq::PREFETCH2) {
    //    printf("Prefetcher request has reached Memory\n");
    //}
    switch (req.type) {
        case PUTS:
        case PUTX:
    ...
    //    switch(*req.state) {
    //        case M:
    //            printf("Eventual request state is M\n");
    //            break;
    //        case E:
    //            printf("Eventual request state is E\n");
    //            break;
    //        case S:
    //            printf("Eventual request state is S\n");
    //            break;
    //        case I:
    //            printf("Eventual request state is I\n");
    //            break;
    //    }
    //}
